	...
	<header>
		<div class="flex items-center justify-between h-16 before:block">
			<div class="grow flex justify-end space-x-4">
				...
				<div class="flex flex-col justify-center">
					...
					<label class="relative cursor-pointer p-2" for="light-switch">
						<svg class="dark:hidden" width="16" height="16" xmlns="http://www.w3.org/2000/svg">
							...
							/>
							<path class="fill-indigo-400" d="M8 4C5.8 4 4 5.8 4 8s1.8 4 4 4 4-1.8 4-4-1.8-4-4-4Z" />
						</svg>
						<svg class="hidden dark:block" width="16" height="16" xmlns="http://www.w3.org/2000/svg">
							<path class="fill-indigo-400" d="M6.2 1C3.2 1.8 1 4.6 1 7.9 1 11.8 4.2 15 8.1 15c3.3 0 6-2.2 6.9-5.2C9.7 11.2 4.8 6.3 6.2 1Z" />
							<path
				...
				<!-- Button -->
				<div>
					<router-link class="btn-sm text-indigo-100 bg-sky-500 hover:bg-sky-600" to="/subscribe">Subscribe</router-link>
				</div>
			</div>
		</div>
	</header>
