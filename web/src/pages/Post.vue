          ...
          <div class="grow md:flex space-y-8 md:space-y-0 md:space-x-8 pt-12 md:pt-16 pb-16 md:pb-20">
            ...
            <div class="grow">
              <div class="max-w-[700px]">
                ...
                <!-- Back -->
                <div class="mb-3">
                  <router-link class="inline-flex text-sky-500 rounded-full border border-slate-200 dark:border-slate-800 dark:bg-linear-to-t dark:from-slate-800 dark:to-slate-800/30" to="/">
                ...
                <article>
                  ...
                  <header>
                    <div class="flex items-center justify-between mb-1">
                      <!-- Post date -->
                      <div class="text-xs text-slate-500 uppercase"><span class="text-sky-500">—</span> Dec 24, 2023 <span class="text-slate-400 dark:text-slate-600">·</span> 4 Min read</div>
                      <!-- Share buttons -->
                      <ul class="inline-flex">
                        <li>
                          <a class="flex justify-center items-center text-slate-400 dark:text-slate-500 hover:text-sky-500 dark:hover:text-sky-500 transition duration-150 ease-in-out" href="#0" aria-label="Twitter">
                        ...
                        <li>
                          <a class="flex justify-center items-center text-slate-400 dark:text-slate-500 hover:text-sky-500 dark:hover:text-sky-500 transition duration-150 ease-in-out" href="#0" aria-label="Facebook">
                            <svg class="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div class="text-slate-500 dark:text-slate-400 space-y-8">
                    ...
                    <div class="space-y-4">
                      ...
                      <p>
                        To pause an element's transition, use getComputedStyle and getPropertyValue at the point in the transition you want to pause it. <a class="font-medium text-sky-500 hover:underline" href="#0">Then set those CSS properties</a> of that element equal to those values you just got.
                      </p>
                    </div>
                    <div class="space-y-4">
                      <h2 class="h2 font-aspekta text-slate-800 dark:text-slate-100">Using CSS “Callback Functions”</h2>
                      <p>
                        Some of the most useful yet little-known JavaScript tricks for manipulating CSS transitions and animations are the DOM events they fire. Like: <strong class="font-medium text-slate-800 dark:text-slate-100">animationend, animationstart, and animationiteration for animations</strong> and transitionend for transitions. You might guess what they do. These animation events fire when the animation on an element ends, starts, or completes one iteration, respectively.
                      </p>
                      <p>
                        These events need to be vendor prefixed at this time, so in this demo, we use a function developed by Craig Buckler called PrefixedEvent, which has the parameters element, type, and callback to help make these events cross-browser. Here is his useful article on capturing CSS animations with JavaScript. And <a class="font-medium text-sky-500 hover:underline" href="#0">here is another one</a> determining which animation (name) the event is firing for.
                      </p>
                    </div>
                    <div class="space-y-4">
                      <h2 class="h2 font-aspekta text-slate-800 dark:text-slate-100">Manipulating CSS Transitions</h2>
...
<span class="text-sky-300">element</span>.<span class="text-sky-300">style</span>.<span class="text-sky-300">webkitAnimationPlayState</span> <span class="text-fuchsia-400">=</span> <span class="text-emerald-400">"running"</span>;</code>
                    ...
                    <div class="space-y-4">
                      ...
                      <p>
                        Unfortunately, at this time, there is no way to get the exact current “percentage completed” of a CSS keyframe animation. <strong class="font-medium text-slate-800 dark:text-slate-100">The best method to approximate it is using a setInterval function</strong> that iterates 100 times during the animation, which is essentially: the animation duration in ms / 100. For example, if the animation is 4 seconds long, then the setInterval needs to run every 40 milliseconds (4000/100).
                      </p>
                    </div>
<pre class="overflow-x-auto text-sm text-slate-500 bg-slate-800 p-4 rounded-sm leading-tight">
<code class="font-pt-mono"><span class="text-sky-300">var showPercent</span> <span class="text-fuchsia-400">=</span> <span class="text-sky-300">window</span>.<span class="text-sky-300">setInterval</span>(<span class="text-emerald-400">function</span>() {
  ...
  <span class="text-sky-300">result</span>.<span class="text-sky-300">innerHTML</span> <span class="text-fuchsia-400">=</span> <span class="text-sky-300">currentPercent</span>;
                    ...
                    <div class="space-y-4">
                      ...
                      <p>
                        Here's a little example of <strong class="font-medium text-slate-800 dark:text-slate-100">where getting clever with HTML and CSS</strong> alone can solve a problem where you might have thought to go to JavaScript.
                      </p>
                    </div>
                    <div class="space-y-4">
