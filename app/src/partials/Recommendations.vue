      ...
      <li class="relative group">
        <div class="flex items-start">
          ...
          <div class="pl-20 space-y-1">
            ...
            <div class="text-sm text-slate-500 dark:text-slate-400">“ James is an excellent developer. He is not just quick to evaluate and translate ideas into high-fidelity codes, but he's also well-versed in UX strategy. While working together, James handled our external partnership with Design Agencies, and delivered weekly progress reports with fresh ideas. ”</div>
          </div>
        </div>
      </li>
    </ul>
